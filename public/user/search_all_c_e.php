...
if(isset($_POST['search_input_all_c_e'])){
	$search_in = trim($_POST['search_input_all_c_e']);
	$search_in_user_id = trim($_POST['search_input_all_c_e_user_id']);
	$hidden = $_POST['search_input_all_c_e_user_hidden'];
	$client_emails = ClientEmail::search_c_e($search_in, $search_in_user_id, $hidden);
}
