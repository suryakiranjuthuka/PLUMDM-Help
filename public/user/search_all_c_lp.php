...
if(isset($_POST['search_input_all_c_lp'])){
	$search_in = trim($_POST['search_input_all_c_lp']);
	$search_in_user_id = trim($_POST['search_input_all_c_lp_user_id']);
	$hidden = $_POST['search_input_all_c_lp_user_hidden'];
	$client_lps = ClientLP::search_c_lp($search_in, $search_in_user_id, $hidden);
}
