...
if(isset($_POST['search_input_all_p_lp'])){
	$search_in = trim($_POST['search_input_all_p_lp']);
	$search_in_user_id = trim($_POST['search_input_all_p_lp_user_id']);
	$hidden = $_POST['search_input_all_p_lp_user_hidden'];
	$plum_lps = PlumLP::search_p_lp($search_in, $search_in_user_id, $hidden);
}
